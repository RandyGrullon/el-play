        ...
        <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
            {games.map((game) => (
                <button
                    ...
                    style={activeGamePk === game.gamePk ? { 
                        boxShadow: `0 0 0 2px ${leagueConfig.color}` 
                    } : undefined}
                >
                    <Card className="p-4 h-full bg-zinc-900/80">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                <span 
                                    className="font-bold"
                                    style={{ color: game.away.isWinner ? leagueConfig.color : '#d4d4d8' }}
                                >
                            ...
                            <div className="flex justify-between items-center">
                                <span 
                                    className="font-bold"
                                    style={{ color: game.home.isWinner ? leagueConfig.color : '#d4d4d8' }}
                                >
